...
@interface PLAudioManagerImpl : PLAudioManager<PLAudioManagerProtocol> {
...
@implementation PLAudioManager

+ (id<PLAudioManagerProtocol>)audioManager {
    static PLAudioManagerImpl *audioManager = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        audioManager = [[PLAudioManagerImpl alloc] init];
    });
    return audioManager;
}
...
@implementation PLAudioManagerImpl
...
- (BOOL) checkAudioRoute
{
    ...
    _audioRoute = (__bridge NSString *)(route);
...
static void sessionPropertyListener(void *                  inClientData,
                                    ...
                                    const void *            inData)
{
    PLAudioManagerImpl *sm = (__bridge PLAudioManagerImpl *)inClientData;
...
{
	PLAudioManagerImpl *sm = (__bridge PLAudioManagerImpl *)inRefCon;

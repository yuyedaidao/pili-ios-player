...
NSString * const PLMovieParameterMinBufferedDuration = @"PLMovieParameterMinBufferedDuration";
NSString * const PLMovieParameterMaxBufferedDuration = @"PLMovieParameterMaxBufferedDuration";
NSString * const PLMovieParameterDisableDeinterlacing = @"PLMovieParameterDisableDeinterlacing";
...
enum {
    ...
    PLMovieInfoSectionGeneral,
    PLMovieInfoSectionVideo,
    PLMovieInfoSectionAudio,
    PLMovieInfoSectionSubtitles,
    PLMovieInfoSectionMetadata,    
    PLMovieInfoSectionCount,
};

enum {

    PLMovieInfoGeneralFormat,
    PLMovieInfoGeneralBitrate,
    PLMovieInfoGeneralCount,
};
...
@interface PLVideoPlayerViewController (){

    PLMovieDecoder      *_decoder;    
...
@property (readwrite, strong)PLArtworkFrame *artworkFrame;
@end

@implementation PLVideoPlayerViewController
...
{    
    ...
    return [[PLVideoPlayerViewController alloc] initWithContentPath:url.absoluteString parameters:parameters];
}
...
//        self.wantsFullScreenLayout = YES;
        ...
        self.controlMode = PLVideoPlayerControlModeDefault;
        
        __weak PLVideoPlayerViewController *weakSelf = self;
        
        PLMovieDecoder *decoder = [[PLMovieDecoder alloc] init];
        
        decoder.interruptCallback = ^BOOL(){
            
            __strong PLVideoPlayerViewController *strongSelf = weakSelf;
...
//    [_progressSlider setThumbImage:[UIImage imageNamed:@"PLmovie.bundle/sliderthumb"]
...
- (void)presentSubtitles
{
    ...
    if ([self subtitleForPosition:_moviePosition
        ...
        if (actual.count){
            ...
            for (PLSubtitleFrame *subtitle in actual.reverseObjectEnumerator){
                    ...
                    outdated: (NSArray **)pOutdated
{
    ...
    for (PLSubtitleFrame *subtitle in _subtitles){
...
{
    if (PLVideoPlayerControlModeNone == self.controlMode) {
        _topBar.alpha = 0;
        _topHUD.alpha = 0;
        _bottomBar.alpha = 0;
...
//    switch (section){
//        case PLMovieInfoSectionGeneral:
//            return PLMovieInfoGeneralCount;
//            
//        case PLMovieInfoSectionMetadata: {
...
//    
//    if (indexPath.section == PLMovieInfoSectionGeneral){
//    
//        if (indexPath.row == PLMovieInfoGeneralBitrate){
//            
...
//            
//        } else if (indexPath.row == PLMovieInfoGeneralFormat){
//
...
//        }
//        
//    } else if (indexPath.section == PLMovieInfoSectionMetadata){
//      
...
//        
//    } else if (indexPath.section == PLMovieInfoSectionVideo){
//        
//        NSArray *a = _decoder.info[@"video"];
...
//        
//    } else if (indexPath.section == PLMovieInfoSectionAudio){
//        
//        NSArray *a = _decoder.info[@"audio"];
...
//        
//    } else if (indexPath.section == PLMovieInfoSectionSubtitles){
//        
//        NSArray *a = _decoder.info[@"subtitles"];
//        
...
//{
//    if (indexPath.section == PLMovieInfoSectionAudio){
//        
...
//                
//                indexPath = [NSIndexPath indexPathForRow:selected inSection:PLMovieInfoSectionAudio];
//                cell = [_tableView cellForRowAtIndexPath:indexPath];
...
//                cell.accessoryType = UITableViewCellAccessoryCheckmark;
//                
//                indexPath = [NSIndexPath indexPathForRow:selected + 1 inSection:PLMovieInfoSectionSubtitles];
//                cell = [_tableView cellForRowAtIndexPath:indexPath];
//                cell.accessoryType = UITableViewCellAccessoryNone;
//            }
//            

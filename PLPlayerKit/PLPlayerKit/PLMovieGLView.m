...
@protocol PLMovieGLRenderer
- (BOOL) isValid;
- (NSString *) fragmentShader;
- (void) resolveUniforms: (GLuint) program;
- (void) setFrame: (PLVideoFrame *) frame;
- (BOOL) prepareRender;
@end

@interface PLMovieGLRenderer_RGB : NSObject<PLMovieGLRenderer> {
...
@implementation PLMovieGLRenderer_RGB
...
@interface PLMovieGLRenderer_YUV : NSObject<PLMovieGLRenderer> {
...
@implementation PLMovieGLRenderer_YUV
...
- (void) setFrame: (PLVideoFrame *) frame
{
    PLVideoFrameYUV *yuvFrame = (PLVideoFrameYUV *)frame;
...
@implementation PLMovieGLView {
    ...
    id<PLMovieGLRenderer> _renderer;
}
             ...
             decoder: (PLMovieDecoder *) decoder
{
    ...
    if (self) {
        ...
        if ([decoder setupVideoFrameFormat:PLVideoFrameFormatYUV]) {
            
            _renderer = [[PLMovieGLRenderer_YUV alloc] init];
            LoggerVideo(1, @"OK use YUV GL renderer");
            
        } else {
            
            _renderer = [[PLMovieGLRenderer_RGB alloc] init];
